    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                @else
                {!!"<p><i><b><a href = 'trangchu/login' >Đăng nhập</a></b> để có thể viết bình luận</i></p>"!!}
                @endif
                <hr>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                <a href="trangchu/tintuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html">
                                    <img class="img-responsive" src="upload/tintuc/{{$tt->Hinh}}" alt="">
                                </a>
                            </div>
                            <div class="col-md-7">
                                <a href="trangchu/tintuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html"><b>{{$tt->TieuDe}}</b></a>
                            </div>
