                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/user/sua/{{$user->id}}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Họ tên</label>
                                <input class="form-control" name="name" placeholder="Điền họ tên" value="{{$user->name}}"/>
                            </div>

                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" placeholder="Nhập địa chỉ mail" value ="{{$user->email}}" readonly="" />
                            </div>    
